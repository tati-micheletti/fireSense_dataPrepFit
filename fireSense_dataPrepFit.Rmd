...
modules <- list("fireSense_dataPrepFit")
objects <- list()
inputs <- list()
outputs <- list()
...
df_params <- moduleParams("fireSense_dataPrepFit", "C:/Ian/Git")
...
If `sourceURL` is specified, `downloadData("fireSense_dataPrepFit", "C:/Ian/Git")` may be sufficient.

```{r moduleInputs, echo = FALSE}
df_inputs <- moduleInputs("fireSense_dataPrepFit", "C:/Ian/Git")
...
df_outputs <- moduleOutputs("fireSense_dataPrepFit", "C:/Ian/Git")
